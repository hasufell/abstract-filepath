...
openDirStream name =
  withFilePath name $ \s -> do
    ...
    return $ unsafeCoerce (Common.DirStream dirp)
...
readDirStream dirs = case unsafeCoerce dirs of
  (Common.DirStream dirp) ->
    let loop ptr_dEnt = do
          resetErrno
    ...
    in alloca $ \ptr_dEnt  -> loop ptr_dEnt
