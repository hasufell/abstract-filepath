...
--
-- Note: calls @chmod@.
setFileMode :: PosixFilePath -> FileMode -> IO ()
setFileMode name m =
...
--
-- Note: calls @access@.
fileAccess :: PosixFilePath -> Bool -> Bool -> Bool -> IO Bool
...
--
-- Note: calls @access@.
fileExist :: PosixFilePath -> IO Bool
fileExist name =
  withFilePath name $ \s -> do
...
access :: PosixFilePath -> CMode -> IO Bool
access name flags =
  withFilePath name $ \s -> do
...
--
-- Note: calls @stat@.
getFileStatus :: PosixFilePath -> IO FileStatus
...
--
-- Note: calls @lstat@.
getSymbolicLinkStatus :: PosixFilePath -> IO FileStatus
...
--
-- Note: calls @mkfifo@.
createNamedPipe :: PosixFilePath -> FileMode -> IO ()
...
--
-- Note: calls @mknod@.
createDevice :: PosixFilePath -> FileMode -> DeviceID -> IO ()
...
--
-- Note: calls @link@.
createLink :: PosixFilePath -> PosixFilePath -> IO ()
...
--
-- Note: calls @symlink@.
createSymbolicLink :: PosixFilePath -> PosixFilePath -> IO ()
...
-- | Reads the @PosixFilePath@ pointed to by the symbolic link and returns it.
--
-- Note: calls @readlink@.
readSymbolicLink :: PosixFilePath -> IO PosixFilePath
...
--
-- Note: calls @rename@.
rename :: PosixFilePath -> PosixFilePath -> IO ()
rename name1 name2 =
  withFilePath name1 $ \s1 ->
  withFilePath name2 $ \s2 ->
...
--
-- Note: calls @chown@.
setOwnerAndGroup :: PosixFilePath -> UserID -> GroupID -> IO ()
...
--
-- Note: calls @lchown@.
setSymbolicLinkOwnerAndGroup :: PosixFilePath -> UserID -> GroupID -> IO ()
...
--
-- Note: calls @utime@.
setFileTimes :: PosixFilePath -> EpochTime -> EpochTime -> IO ()
...
--
setFileTimesHiRes :: PosixFilePath -> POSIXTime -> POSIXTime -> IO ()
...
-- - HFS+ volumes on OS X truncate the sub-second part of the timestamp.
--
setSymbolicLinkTimesHiRes :: PosixFilePath -> POSIXTime -> POSIXTime -> IO ()
#if HAVE_UTIMENSAT
...
--
-- Note: calls @lutimes@.
touchSymbolicLink :: PosixFilePath -> IO ()
#if HAVE_LUTIMES
...
--
-- Note: calls @truncate@.
setFileSize :: PosixFilePath -> FileOffset -> IO ()
...
--
-- Note: calls @pathconf@.
getPathVar :: PosixFilePath -> PathVar -> IO Limit
