...
import System.Win32.WindowsString.Types   ( HANDLE, DWORD, BOOL, LPCTSTR, withTString
...
import Foreign                  ( Ptr, nullPtr, maybeWith, FunPtr
...
mapFile :: WindowsFilePath -> IO (ForeignPtr a, Int)
mapFile path = do
    bracket
